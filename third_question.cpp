...
int best_interests(std::map<int, double> rate_grid, int long_loan_duration) {
	double	ret = 0.0;
	...
	std::cout << "Best interests for the short loan with a total loan duration of 25 years based on the grid is the " << ret;
